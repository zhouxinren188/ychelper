...
assert.match(rules, /update-1\.0\.66\.2\.zip/);
...
assert.match(onlineVerifier, /bootstrapData\.version !== '1\.0\.66\.2'/);
assert.match(onlineVerifier, /legacy-full-installer-fallback-v2/);
